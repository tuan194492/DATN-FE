...
k.defaults,c);this.s={dt:new l.Api(b),namespace:".autoFill"+t++,scroll:{},scrollInterval:null,handle:{height:0,width:0},enabled:!1};this.dom={handle:e('<div className="dt-autofill-handle"/>'),select:{top:e('<div className="dt-autofill-select top"/>'),right:e('<div className="dt-autofill-select right"/>'),bottom:e('<div className="dt-autofill-select bottom"/>'),left:e('<div className="dt-autofill-select left"/>')},background:e('<div className="dt-autofill-background"/>'),list:e('<div className="dt-autofill-list">'+this.s.dt.i18n("autoFill.info",
...
function(f,j){h.append(e("<li/>").append('<div className="dt-autofill-question">'+d[j].option(a,b)+"<div>").append(e('<div className="dt-autofill-button">').append(e('<button className="'+k.classes.btn+'">'+a.i18n("autoFill.button","&gt;")+"</button>").on("click",function(){var f=d[j].execute(a,b,e(this).closest("li"));c._update(f,b);c.dom.background.remove();c.dom.list.remove()}))))});this.dom.background.appendTo("body");this.dom.list.appendTo("body");this.dom.list.css("margin-top",-1*(this.dom.list.outerHeight()/
