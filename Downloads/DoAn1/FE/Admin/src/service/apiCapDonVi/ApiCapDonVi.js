...
// Địa chỉ gốc của API
const API_BASE_URL = 'http://127.0.0.1:8000/api/CapNhomDonVi';
...
export const fetchCapDonVi = async (id) => {
  try {
...
// Create
export const createCapDonVi = async (userData) => {
  try {
...
// UPDATE
export const updateCapDonVi = async (id, userData) => {
  try {
...
// DELETE
export const deleteCapDonVi = async (id) => {
  try {
